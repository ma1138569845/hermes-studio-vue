...
describe('Ekko capability recovery', () => {
  ...
  it.skipIf(process.platform === 'win32')('falls back to ephemeral SQLite and repairs the persistent target with migrations', async () => {
  ...
  it.skipIf(process.platform === 'win32')('requires approval for rebuild and recovers compatible data before reindexing', async () => {
