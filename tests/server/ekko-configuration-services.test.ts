...
describe('Ekko configuration services', () => {
  ...
  it('creates, reads, edits, and archives profile skills', { timeout: 60_000 }, async () => {
  ...
  it('references external Skill roots and imports local Skill folders per Profile', { timeout: 120000 }, async () => {
