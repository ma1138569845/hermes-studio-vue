...
export default {
  ...
  browser: {
    title: '瀏覽器', settings: '瀏覽器設定', desktopOnly: '內建瀏覽器僅在 智能审 桌面版可用。', newTab: '新分頁',
  ...
  runtimeVersions: {
    ...
    cliUpdateDescription: 'Hermes Runtime 0.19.1 及以上版本支援透過以下指令單獨升級內建的 Hermes Agent；此指令不會升級 智能审 桌面端或 Web UI。執行前請先完全結束 智能审：',
    webUiTitle: 'Web UI',
    platform: '平台',
    ...
    runtimeDirectorySaved: 'Runtime 遷移已排程，重新啟動 智能审 後執行。',
    runtimeMigrationPending: '待遷移至：{directory}',
    runtimeMigrationFailed: '儲存目錄遷移失敗，已繼續使用原目錄',
    runtimeActivationFailed: '所選 Runtime 無法啟動，智能审 已改用其他已安裝版本',
    active: '已啟用',
    installed: '已安裝',
    download: '下載',
    ...
    activateSuccess: '版本選擇已儲存，重啟 智能审 後生效。',
  ...
  settings: {
    ...
    voice: {
      ...
      hermesConfigDescription: 'Hermes profile 中原有的原生提供商會繼續保留；Web UI 管理的提供商對 Hermes 統一顯示為 智能审。',
  ...
  knowledgeBase: {
    ...
    userBases: '我的知識庫',
    system: '系統',
    empty: '尚無知識庫，點擊上方按鈕建立一個。',
    noDescription: '沒有描述',
    deleteConfirm: '確定要刪除這個知識庫嗎？所有文件與資料將被永久移除。',
    namePlaceholder: '知識庫名稱',
    ...
    wiki: 'Wiki',
    wikiPages: 'Wiki 頁面',
    noWikiPages: '還沒有 Wiki。可從已完成向量化的文件產生，或使用頂部「產生」。',
    stats: '統計',
    entities: '實體',
    relationships: '關係',
    totalSize: '總大小',
    ...
    generate: '產生',
    rebuild: '重建索引',
    rebuildConfirm: '將重新排隊本知識庫全部文件的向量化，現有分塊會被取代。確定繼續？',
    rebuildQueued: '重建任務已排隊',
    folderWiki: '資料夾 Wiki',
    bulkWiki: '為已完成文件產生 Wiki',
    hierarchicalWiki: '分層 Wiki',
    curate: '策展',
    curateApproved: '策展已通過頁面',
    open: '開啟',
    selectedCount: '已選 {n} 項',
    bulkDeleteConfirm: '永久刪除所選文件？',
    deleteDocConfirm: '刪除這份文件？',
    deleteChunkConfirm: '刪除該分塊及其向量？',
    llmConfirmTitle: '將呼叫語言模型',
    llmConfirmBody: '摘要、Wiki、圖譜和策展可能耗時數分鐘，並消耗模型額度。是否繼續？',
    actionStarted: '已開始',
    actionFailed: '操作失敗',
    wikiSkipped: 'Wiki 已是最新，無需重寫',
    wikiOnly: '僅產生 Wiki',
    wikiAndCurate: '產生 Wiki 並策展',
    searchModeVector: '向量',
    searchModeWiki: 'Wiki',
    searchModeGraph: '圖譜',
    searchModeUnified: '綜合',
    reviewAll: '全部審閱',
    reviewPending: '待審閱',
    reviewApproved: '已通過',
    reviewRejected: '已駁回',
    approve: '通過',
    reject: '駁回',
    evaluateQuality: '品質評分',
    quality: '品質',
    qualityUpdated: '品質評分已更新',
    noPreview: '暫無預覽',
    noChunks: '暫無分塊，請先向量化文件。',
    noGraph: '暫無圖譜。開啟已完成的文件並抽取實體。',
    noJobs: '暫無最近任務',
  },
}
