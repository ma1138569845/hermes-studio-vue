export default {
  browser: {
    title: 'Browser', settings: 'Browser Settings', desktopOnly: 'The embedded browser is available only in DechnicAuditor Desktop.', newTab: 'New Tab',
  ...
  runtimeVersions: {
    ...
    cliUpdateDescription: 'Hermes Runtime 0.19.1 and later can use the following command to update the bundled Hermes Agent only. It does not update the DechnicAuditor desktop app or Web UI. Fully quit DechnicAuditor before running:',
    webUiTitle: 'Web UI',
    platform: 'Platform',
    ...
    runtimeDirectorySaved: 'Runtime migration scheduled. Restart DechnicAuditor to apply it.',
    ...
    runtimeActivationFailed: 'The selected Runtime could not start, so DechnicAuditor used another installed version',
    active: 'Active',
    installed: 'Installed',
    download: 'Download',
    ...
    activateSuccess: 'Version selection saved. Restart DechnicAuditor to use it.',
    jobStatus: {
      queued: 'Queued',
      running: 'Running',
      completed: 'Completed',
  ...
  office: {
    ...
    ambient2: 'Could you take a look at how I should handle this part?',
    ambient3: 'Some info just came in — let\'s align on it.',
    ambient4: 'That thing we discussed has a result — come see.',
    visitFallback: 'Got something to sync with you.',
    unassigned: 'Unassigned',
    empty: { tasks: 'No matching tasks' },
    tab: { config: 'Config', skills: 'Skills', memory: 'Memory', tasks: 'Tasks', archive: 'Archive', chat: 'Chat' },
    agent: {
      notes: 'Memory notes',
      userProfile: 'User profile',
      soulEmpty: 'No SOUL has been written yet.',
      memoryEmpty: 'No memory notes yet.',
      userEmpty: 'No user profile yet.',
      skillsEmpty: 'No skills available.',
      tasksEmpty: 'No open tasks assigned to this agent.',
  ...
  settings: {
    ...
    voice: {
      ...
      hermesConfigDescription: 'Existing native providers remain in the Hermes profile. Web UI providers appear to Hermes as DechnicAuditor.',
      hermesActiveProvider: 'Active provider',
      hermesConfiguredProviders: 'Configured providers',
      hermesStudioProvider: 'DechnicAuditor',
      providerSpeed: 'Speed',
      ...
      useHermesStudioProvider: 'Use DechnicAuditor provider',
  ...
  knowledgeBase: {
    ...
    create: 'Create KB',
    systemBases: 'System KBs',
    userBases: 'My KBs',
    system: 'System',
    empty: 'No knowledge bases yet. Click the button above to create one.',
    noDescription: 'No description',
    deleteConfirm: 'Delete this knowledge base? All documents and data will be permanently removed.',
    ...
    noWikiPages: 'No wiki pages yet. Generate from a completed document or use Generate in the header.',
    stats: 'Statistics',
    entities: 'Entities',
    ...
    content: 'Content',
    score: 'Score',
    upstreamError: 'Knowledge service unreachable',
    vectorize: 'Embed',
    revectorize: 'Re-embed',
    summary: 'Summary',
    graph: 'Graph',
    jobs: 'Jobs',
    generate: 'Generate',
    rebuild: 'Rebuild index',
    rebuildConfirm: 'Re-queue embedding for every document in this knowledge base? Existing chunks will be replaced.',
    rebuildQueued: 'Rebuild queued',
    folderWiki: 'Folder wiki',
    bulkWiki: 'Wiki for completed documents',
    hierarchicalWiki: 'Hierarchical wiki',
    curate: 'Curate',
    curateApproved: 'Curate approved pages',
    open: 'Open',
    selectedCount: '{n} selected',
    bulkDeleteConfirm: 'Delete the selected documents permanently?',
    deleteDocConfirm: 'Delete this document?',
    deleteChunkConfirm: 'Delete this chunk and its vector?',
    llmConfirmTitle: 'This calls the language model',
    llmConfirmBody: 'Summary, wiki, graph, and curation jobs may take several minutes and consume model tokens. Continue?',
    actionStarted: 'Started',
    actionFailed: 'Action failed',
    wikiSkipped: 'Wiki already up to date',
    wikiOnly: 'Generate wiki',
    wikiAndCurate: 'Generate wiki and curate',
    searchModeVector: 'Vectors',
    searchModeWiki: 'Wiki',
    ...
    approve: 'Approve',
    reject: 'Reject',
    evaluateQuality: 'Score quality',
    quality: 'Quality',
    qualityUpdated: 'Quality score updated',
    noPreview: 'No preview available',
    noChunks: 'No chunks yet. Embed the document first.',
    noGraph: 'No graph yet. Open a completed document and extract entities.',
