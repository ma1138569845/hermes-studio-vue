export default {
  browser: {
    title: 'ブラウザー', settings: 'ブラウザー設定', desktopOnly: '内蔵ブラウザーは DechnicAuditor Desktop でのみ利用できます。', newTab: '新しいタブ',
  ...
  office: {
    ...
    ambient2: 'この部分の扱いについて見てもらえますか？',
    ambient3: '届いた情報について、認識を合わせましょう。',
    ambient4: '前に話した件に結果が出ました。見に来てください。',
    visitFallback: '同期したいことがあります。',
    unassigned: '未割当',
    empty: { tasks: '該当タスクなし' },
    tab: { config: '設定', skills: 'スキル', memory: '記憶', tasks: 'タスク', archive: 'アーカイブ', chat: 'チャット' },
    agent: {
      notes: '記憶ノート',
      userProfile: 'ユーザープロフィール',
      soulEmpty: 'SOUL がまだ書かれていません。',
      memoryEmpty: '記憶ノートはまだありません。',
      userEmpty: 'ユーザープロフィールはまだありません。',
      skillsEmpty: '利用可能なスキルがありません。',
      tasksEmpty: 'このエージェントに未アーカイブのタスクはありません。',
      archiveEmpty: 'アーカイブ済みタスクはありません。',
  ...
  runtimeVersions: {
    ...
    cliUpdateDescription: 'Hermes Runtime 0.19.1 以降では、次のコマンドで内蔵 Hermes Agent のみを更新できます。DechnicAuditor デスクトップアプリや Web UI は更新されません。実行前に DechnicAuditor を完全に終了してください：',
    webUiTitle: 'Web UI',
    platform: 'プラットフォーム',
    ...
    runtimeDirectorySaved: 'Runtime の移行を予約しました。DechnicAuditor を再起動すると実行されます。',
    runtimeMigrationPending: '移行先：{directory}',
    runtimeMigrationFailed: '保存先の移行に失敗したため、以前の保存先を引き続き使用します',
    runtimeActivationFailed: '選択した Runtime を起動できなかったため、DechnicAuditor は別のインストール済みバージョンを使用しています',
    active: '有効',
    installed: 'インストール済み',
    download: 'ダウンロード',
    ...
    activateSuccess: 'バージョン選択を保存しました。DechnicAuditor を再起動すると反映されます。',
    jobStatus: {
      queued: '待機中',
      running: '実行中',
      completed: '完了',
  ...
  settings: {
    ...
    voice: {
      ...
      hermesConfigDescription: 'Hermes プロファイルの既存ネイティブプロバイダーは保持され、Web UI のプロバイダーは DechnicAuditor として表示されます。',
      ...
      useHermesStudioProvider: 'DechnicAuditor プロバイダーを使用',
