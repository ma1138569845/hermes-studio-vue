export default {
  browser: {
    title: '브라우저', settings: '브라우저 설정', desktopOnly: '내장 브라우저는 DechnicAuditor Desktop에서만 사용할 수 있습니다.', newTab: '새 탭',
  ...
  office: {
    ...
    ambient2: '이 부분을 어떻게 처리해야 할지 확인해 주시겠어요?',
    ambient3: '방금 정보가 들어왔습니다 — 의견을 맞춰보죠.',
    ambient4: '앞서 논의한 것에 결과가 나왔습니다 — 와서 확인하세요.',
    visitFallback: '동기화할 내용이 있습니다.',
    unassigned: '미할당',
    empty: { tasks: '일치하는 작업이 없습니다' },
    tab: { config: '설정', skills: '스킬', memory: '메모리', tasks: '작업', archive: '아카이브', chat: '채팅' },
    agent: {
      notes: '메모리 노트',
      userProfile: '사용자 프로필',
      soulEmpty: '아직 SOUL이 작성되지 않았습니다.',
      memoryEmpty: '아직 메모리 노트가 없습니다.',
      userEmpty: '아직 사용자 프로필이 없습니다.',
      skillsEmpty: '사용 가능한 스킬이 없습니다.',
      tasksEmpty: '이 에이전트에 미보관 작업이 없습니다.',
      archiveEmpty: '보관된 작업이 없습니다.',
  ...
  runtimeVersions: {
    ...
    cliUpdateDescription: 'Hermes Runtime 0.19.1 이상에서는 다음 명령으로 내장 Hermes Agent만 업데이트할 수 있습니다. DechnicAuditor 데스크톱 앱이나 Web UI는 업데이트되지 않습니다. 실행 전에 DechnicAuditor를 완전히 종료하세요:',
    webUiTitle: 'Web UI',
    platform: '플랫폼',
    ...
    runtimeDirectorySaved: 'Runtime 마이그레이션을 예약했습니다. DechnicAuditor를 다시 시작하면 실행됩니다.',
    runtimeMigrationPending: '마이그레이션 예정 위치: {directory}',
    runtimeMigrationFailed: '저장소 마이그레이션에 실패하여 이전 저장소를 계속 사용합니다',
    runtimeActivationFailed: '선택한 Runtime을 시작할 수 없어 DechnicAuditor가 설치된 다른 버전을 사용했습니다',
    active: '활성',
    installed: '설치됨',
    download: '다운로드',
    ...
    activateSuccess: '버전 선택이 저장되었습니다. DechnicAuditor를 다시 시작하면 적용됩니다.',
    jobStatus: {
      queued: '대기 중',
      running: '실행 중',
      completed: '완료',
  ...
  settings: {
    ...
    voice: {
      ...
      hermesConfigDescription: 'Hermes 프로필의 기존 네이티브 제공자는 유지되며 Web UI 제공자는 DechnicAuditor로 표시됩니다.',
      ...
      useHermesStudioProvider: 'DechnicAuditor 제공자 사용',
