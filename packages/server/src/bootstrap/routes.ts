...
import { officeRoutes } from '../modules/hermes/routes/office'
import { knowledgeBaseRoutes } from '../modules/hermes/routes/knowledge-base'
...
export function registerRoutes(app: any, authMiddleware: Array<(ctx: Context, next: Next) => Promise<void>>) {
  ...
  app.use(knowledgeBaseRoutes.routes())    // Knowledge base doc pipeline pass-through
}
