...
export const HERMES_MCP_USAGE_GUIDELINES = [
  ...
  'Do not use hermes_studio_use_chat_run, DechnicAuditor session tools, /api/chat-run/*, or /api/hermes/sessions/* as an internal delegation mechanism. In delegate_task, subtask, or workflow-node contexts, do not create, rename, delete, or continue DechnicAuditor sessions unless the user explicitly asked to operate DechnicAuditor sessions; return the delegated result in the current task instead.',
];
