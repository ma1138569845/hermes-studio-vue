...
const translations: Record<DesktopLocale, Record<TranslationKey, string>> = {
  en: {
    'tray.show': 'Show DechnicAuditor',
    'tray.hide': 'Hide DechnicAuditor',
    'tray.checkForUpdates': 'Check for Updates',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': 'Open at Login',
    'tray.quit': 'Quit DechnicAuditor',
    'update.upToDateTitle': 'DechnicAuditor',
    'update.upToDateMessage': 'DechnicAuditor is up to date.',
    'update.checkingTitle': 'DechnicAuditor',
    ...
    'update.availableMessage': 'DechnicAuditor {version} is available.',
    ...
    'update.readyMessage': 'DechnicAuditor {version} is ready to install.',
    ...
    'update.failedMessage': 'Could not check for DechnicAuditor updates.',
    ...
    'desktop.downloadCloudflareDetail': 'Use the DechnicAuditor download proxy.',
    ...
    'loginReset.confirmDetail': 'DechnicAuditor will restart its local Web UI service, clear login locks, and return to the login page.',
  ...
  zh: {
    ...
    'desktop.downloadCloudflareDetail': '使用 智能审 下载代理。',
    ...
    'loginReset.confirmDetail': '智能审 会重启本地 Web UI 服务、清除登录失败锁，然后回到登录页。',
  ...
  'zh-TW': {
    ...
    'desktop.downloadCloudflareDetail': '使用 智能审 下載代理。',
    ...
    'loginReset.confirmDetail': '智能审 會重新啟動本地 Web UI 服務、清除登入失敗鎖，然後回到登入頁。',
  ...
  ja: {
    'tray.show': 'DechnicAuditor を表示',
    'tray.hide': 'DechnicAuditor を隠す',
    'tray.checkForUpdates': 'アップデートを確認',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': 'ログイン時に開く',
    'tray.quit': 'DechnicAuditor を終了',
    'update.upToDateTitle': 'DechnicAuditor',
    'update.upToDateMessage': 'DechnicAuditor は最新です。',
    'update.checkingTitle': 'DechnicAuditor',
    'update.checkingMessage': 'アップデートを確認しています...',
    'update.currentVersion': '現在のバージョン: {version}',
    'update.availableTitle': 'アップデートがあります',
    'update.availableMessage': 'DechnicAuditor {version} が利用できます。',
    ...
    'desktop.downloadCloudflareDetail': 'DechnicAuditor のダウンロードプロキシを使用します。',
  ...
  ko: {
    ...
    'update.failedMessage': 'DechnicAuditor 업데이트를 확인할 수 없습니다.',
    ...
    'desktop.downloadCloudflareDetail': 'DechnicAuditor 다운로드 프록시를 사용합니다.',
  ...
  fr: {
    'tray.show': 'Afficher DechnicAuditor',
    'tray.hide': 'Masquer DechnicAuditor',
    'tray.checkForUpdates': 'Rechercher les mises a jour',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': 'Ouvrir a la connexion',
    'tray.quit': 'Quitter DechnicAuditor',
    'update.upToDateTitle': 'DechnicAuditor',
    'update.upToDateMessage': 'DechnicAuditor est a jour.',
    'update.checkingTitle': 'DechnicAuditor',
    ...
    'update.availableMessage': 'DechnicAuditor {version} est disponible.',
    ...
    'update.readyMessage': 'DechnicAuditor {version} est pret a etre installe.',
    ...
    'update.failedMessage': 'Impossible de rechercher les mises a jour de DechnicAuditor.',
    ...
    'desktop.downloadCloudflareDetail': 'Utilise le proxy de telechargement DechnicAuditor.',
  ...
  es: {
    'tray.show': 'Mostrar DechnicAuditor',
    'tray.hide': 'Ocultar DechnicAuditor',
    'tray.checkForUpdates': 'Buscar actualizaciones',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': 'Abrir al iniciar sesion',
    'tray.quit': 'Salir de DechnicAuditor',
    'update.upToDateTitle': 'DechnicAuditor',
    'update.upToDateMessage': 'DechnicAuditor esta actualizado.',
    'update.checkingTitle': 'DechnicAuditor',
    ...
    'update.availableMessage': 'DechnicAuditor {version} esta disponible.',
    ...
    'update.readyMessage': 'DechnicAuditor {version} esta listo para instalarse.',
    ...
    'update.failedMessage': 'No se pudieron buscar actualizaciones de DechnicAuditor.',
    ...
    'desktop.downloadCloudflareDetail': 'Usa el proxy de descarga de DechnicAuditor.',
  ...
  de: {
    'tray.show': 'DechnicAuditor anzeigen',
    'tray.hide': 'DechnicAuditor ausblenden',
    'tray.checkForUpdates': 'Nach Updates suchen',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': 'Beim Anmelden offnen',
    'tray.quit': 'DechnicAuditor beenden',
    'update.upToDateTitle': 'DechnicAuditor',
    'update.upToDateMessage': 'DechnicAuditor ist auf dem neuesten Stand.',
    'update.checkingTitle': 'DechnicAuditor',
    ...
    'update.availableMessage': 'DechnicAuditor {version} ist verfugbar.',
    ...
    'update.readyMessage': 'DechnicAuditor {version} ist zur Installation bereit.',
    ...
    'update.failedMessage': 'Updates fur DechnicAuditor konnten nicht gepruft werden.',
    ...
    'desktop.downloadCloudflareDetail': 'Verwendet den DechnicAuditor Download-Proxy.',
  ...
  pt: {
    ...
    'tray.quit': 'Sair do DechnicAuditor',
    'update.upToDateTitle': 'DechnicAuditor',
    'update.upToDateMessage': 'DechnicAuditor esta atualizado.',
    'update.checkingTitle': 'DechnicAuditor',
    ...
    'update.availableMessage': 'DechnicAuditor {version} esta disponivel.',
    ...
    'update.readyMessage': 'DechnicAuditor {version} esta pronto para instalar.',
    ...
    'update.failedMessage': 'Nao foi possivel verificar atualizacoes do DechnicAuditor.',
    ...
    'desktop.downloadCloudflareDetail': 'Usa o proxy de download do DechnicAuditor.',
